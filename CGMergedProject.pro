...
unrealRootPath=/home/leon/Downloads/UnrealEngine-4.14.1-release
CGMergedProjectRootPath=/home/leon/Dokumente/Unreal Projects/CGMergedProject

gameProjectFile=/home/leon/Dokumente/Unreal Projects/CGMergedProject/CGMergedProject.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(CGMergedProjectSource.pri)
include(CGMergedProjectHeader.pri)
include(CGMergedProjectConfig.pri)
include(CGMergedProjectIncludes.pri)
include(CGMergedProjectDefines.pri)
...
CGMergedProject-Linux-Debug.commands = $$build CGMergedProject Linux Debug  -project="\"$$gameProjectFile\"" $$args
CGMergedProject-Linux-DebugGame.commands = $$build CGMergedProject Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
CGMergedProject-Linux-Shipping.commands = $$build CGMergedProject Linux Shipping  -project="\"$$gameProjectFile\"" $$args
CGMergedProject-Linux-Test.commands = $$build CGMergedProject Linux Test  -project="\"$$gameProjectFile\"" $$args
CGMergedProject.commands = $$build CGMergedProject Linux Development  -project="\"$$gameProjectFile\"" $$args

CGMergedProjectEditor-Linux-Debug.commands = $$build CGMergedProjectEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
CGMergedProjectEditor-Linux-DebugGame.commands = $$build CGMergedProjectEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
CGMergedProjectEditor-Linux-Shipping.commands = $$build CGMergedProjectEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
CGMergedProjectEditor-Linux-Test.commands = $$build CGMergedProjectEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
CGMergedProjectEditor.commands = $$build CGMergedProjectEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	CGMergedProject-Linux-Debug \
	CGMergedProject-Linux-DebugGame \
	CGMergedProject-Linux-Shipping \
	CGMergedProject-Linux-Test \
	CGMergedProject \
	CGMergedProjectEditor-Linux-Debug \
	CGMergedProjectEditor-Linux-DebugGame \
	CGMergedProjectEditor-Linux-Shipping \
	CGMergedProjectEditor-Linux-Test \
	CGMergedProjectEditor \
