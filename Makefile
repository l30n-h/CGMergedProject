...
CGMergedProject-Linux-Debug:
	 $(PROJECTBUILD) CGMergedProject Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

CGMergedProject-Linux-DebugGame:
	 $(PROJECTBUILD) CGMergedProject Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

CGMergedProject-Linux-Shipping:
	 $(PROJECTBUILD) CGMergedProject Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

CGMergedProject-Linux-Test:
	 $(PROJECTBUILD) CGMergedProject Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

CGMergedProject:
	 $(PROJECTBUILD) CGMergedProject Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

CGMergedProjectEditor-Linux-Debug:
	 $(PROJECTBUILD) CGMergedProjectEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

CGMergedProjectEditor-Linux-DebugGame:
	 $(PROJECTBUILD) CGMergedProjectEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

CGMergedProjectEditor-Linux-Shipping:
	 $(PROJECTBUILD) CGMergedProjectEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

CGMergedProjectEditor-Linux-Test:
	 $(PROJECTBUILD) CGMergedProjectEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

CGMergedProjectEditor:
	 $(PROJECTBUILD) CGMergedProjectEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
